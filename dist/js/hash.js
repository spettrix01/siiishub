// SHA-256, the browser's own when it has one: crypto.subtle exists only on
// HTTPS and on localhost, and the browser version of SIIISHUB is often
// reached over plain HTTP on a home network.
...
function sha256Js(data) {
  // The message, a 1 bit, zeros, and its length in bits: whole 64-byte blocks.
...
/** The SHA-256 digest of `bytes` (a Uint8Array). */
