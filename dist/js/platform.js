...
// `is-android` class on <html>. Phones and tablets get the mobile layout
// (`is-phone`); Android TV, which has no touchscreen, keeps the big-screen
// layout and is driven with the remote's D-pad (`is-tv`, tv-nav.js). The
// app, not a browser on Android: there the page is the web interface, the
// same as on Windows and Linux.
